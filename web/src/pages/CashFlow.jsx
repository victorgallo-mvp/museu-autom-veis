...
import { Wallet, Receipt, HandCoins, Landmark, Plus, Pencil, Trash2, ScrollText } from 'lucide-react';
    ...
    <div>
      ...
      {loadingSummary ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          ...
          <StatCard
            icon={Receipt}
            label="Despesas pagas pelo caixa"
            value={formatCurrency(ongTotals(summary.totals).expenses)}
          />
          <StatCard
            icon={HandCoins}
            label="Já repassado"
          ...
          <StatCard
            icon={Wallet}
            label="Pendente de repasse (saldo em caixa)"
